...
{
  \begin{cvitems}
    \item Converted complex, business-driven biotech data into lazy-loaded, Parquet-backed ML-ready datasets enabling domain-specific feature extraction while preserving performance; validated with schema checks and benchmarks.
    \item Improved model reliability by implementing unit tests and schema validation for training and inference modules, reducing data-related failures in production.
  \end{cvitems}
}
%---------------------------------------------------------
\cventry
